...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger VEERY_FORMAT_RAW;)
+ (NSInteger)VEERY_FORMAT_RAW SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger VEERY_FORMAT_EXTRAPOLATED;)
+ (NSInteger)VEERY_FORMAT_EXTRAPOLATED SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger LOCAL_FOREGROUND;)
+ (NSInteger)LOCAL_FOREGROUND SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger LOCAL_BACKGROUND;)
+ (NSInteger)LOCAL_BACKGROUND SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger BACKEND_BACKGROUND;)
+ (NSInteger)BACKEND_BACKGROUND SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger BACKEND_GEOPROFILE;)
+ (NSInteger)BACKEND_GEOPROFILE SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger DEACTIVE_ALL;)
+ (NSInteger)DEACTIVE_ALL SWIFT_WARN_UNUSED_RESULT;
...
- (void)setSubscription:(NSString * _Nonnull)subscriptionType :(NSString * _Nonnull)notificationFormat;
- (void)setUnSubscription:(NSString * _Nonnull)subscriptionType;
...
- (Trip * _Nullable)getNextTrip SWIFT_WARN_UNUSED_RESULT;
...
- (NSArray<NSData *> * _Nonnull)getPointOfInterests SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtCC5Veery5Veery4Trip")
...
- (void)veeryOnRouteMatched:(Veery * _Nonnull)veery locationsHistory:(LocationsHistory * _Nonnull)locationsHistory;
- (void)veeryOnPredictionUpdate:(Veery * _Nonnull)veery trip:(Trip * _Nonnull)trip;
@end
